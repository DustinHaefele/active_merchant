    ...
    class PayTraceGateway < Gateway
      ...
      def purchase(money, payment_or_customerid, options = {})
        ...
        if payment_or_customerid.class == String
          ...
          response = commit('transactions/sale/by_customer', post)
          check_token_response(response, 'transactions/sale/by_customer', post, options)
        else
          add_payment(post, payment_or_customerid)
          add_address(post, payment_or_customerid, options)
          add_customer_data(post, options)

          response = commit('transactions/sale/keyed', post)
          check_token_response(response, 'transactions/sale/keyed', post, options)
        end
      end
      ...
      def authorize(money, payment_or_customerid, options = {})
        ...
        if payment_or_customerid.class == String
          ...
          response = commit('transactions/authorization/by_customer', post)
          check_token_response(response, 'transactions/authorization/by_customer', post, options)
        else
          add_payment(post, payment_or_customerid)
          add_address(post, payment_or_customerid, options)
          add_customer_data(post, options)

          response = commit('transactions/authorization/keyed', post)
          check_token_response(response, 'transactions/authorization/keyed', post, options)
        end
      end
      ...
      def capture(authorization, options = {})
        ...
        response = commit('transactions/authorization/capture', post)
        check_token_response(response, 'transactions/authorization/capture', post, options)
      end
      ...
      def refund(authorization, options = {})
        ...
        post[:amount] = options[:amount] if options[:amount]
        post[:transaction_id] = authorization
        response = commit('transactions/refund/for_transaction', post)
        check_token_response(response, 'transactions/refund/for_transaction', post, options)
      end
      ...
      def void(authorization, options = {})
        ...
        response = commit('transactions/void', post)
        check_token_response(response, 'transactions/void', post, options)
      end
      ...
      def store(credit_card, options = {})
        ...
        response = commit('customer/create', post)
        check_token_response(response, 'customer/create', post, options)
      end

      def redact(customer_id)
        post = {}
        post[:customer_id] = customer_id
        response = commit('customer/delete', post)
        check_token_response(response, 'customer/delete', post, options)
      end
