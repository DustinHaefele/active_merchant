...
class RemotePayTraceTest < Test::Unit::TestCase
  ...
  def test_successful_refund
    ...
    refund = @gateway.refund(authorization, @options.merge(amount: 1.00))
  ...
  # Not including a test_failed_verify since the only way to force a failure on this gateway is with a specific dollar amount. Since verify is auth and void combined, having separate tests for auth and void should suffice.
